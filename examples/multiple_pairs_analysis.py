...
def run_agent_multiple_pairs_analysis(provider='openai'):
    """
    ...
    print(f"Running agent-based momentum analysis for {symbol} using {provider}")
    print(f"Parameters: {len(ma_pairs)} MA pairs: {ma_pairs}")

    # Create agents
    agents = create_agents(provider=provider, work_dir="output")
